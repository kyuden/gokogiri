...
import (
	"github.com/kyuden/gokogiri/html"
...
found in the github.com/kyuden/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
